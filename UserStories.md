# User Stories for StudyMate

1. [ ] Replace current sticky note system
2. [x] Add a public facing page with basic contact info 
3. [x] Add a passwordless login to the app 
...
7. [x] Require users to login at least once per day
8. [x] Provide a way to remove access asap if needed
...
13. [x] Users can have Student, Teacher, or Admin permissions 
